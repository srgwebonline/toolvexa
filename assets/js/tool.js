...
// Percentage Calculator JavaScript (Only if on percentage calculator page)
if (document.getElementById('calculatorTabs')) {
  // DOM Elements
...
// FAQ functionality (available on all pages)
